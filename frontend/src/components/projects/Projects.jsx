      ...
      {projects.length > 3 && (
        <div className="text-center mt-12">
          <button
            ...
            className="bg-blue-600 hover:bg-blue-800 text-white px-6 py-2 rounded-full text-sm font-semibold transition duration-300"
          >
              ...
              <div className="lg:p-8 p-6">
                ...
                <div className="flex gap-4">
                  <a
                    ...
                    className={`${selectedProject.id === 2 ? 'w-full' : 'w-1/2'
                      } bg-gray-800 hover:bg-blue-800 text-gray-400 lg:px-6 lg:py-2 px-2 py-1 rounded-xl lg:text-xl text-sm font-semibold text-center`}
                  >
                    View Code
                  </a>
